...
const Pagination = ({ count }) => {
  ...
  const startPoint = (currentPage - 1) * PAGE_SIZE + 1;
  const endPoint = currentPage * PAGE_SIZE > count ? count : currentPage * PAGE_SIZE;
  ...
  return (
    <StyledPagination>
      <P>
        Showing <span>{startPoint}</span> to <span>{endPoint}</span> of{" "}
